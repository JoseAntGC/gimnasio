...
<div class="container py-4">
  ...
  <form method="POST" action="{{ route('empleados.update',$empleado) }}">
    ...
    <div class="row">
      <div class="col-md-6 mb-3"><label class="form-label">DNI</label><input name="DNI" pattern="[0-9]{8}[A-Za-z]" maxlength="9" class="form-control" value="{{ old('DNI',$empleado->DNI) }}" required></div>
      <div class="col-md-6 mb-3"><label class="form-label">Teléfono</label><input name="telefono" inputmode="numeric" pattern="[6789][0-9]{8}" maxlength="9" class="form-control" value="{{ old('telefono',$empleado->telefono) }}" required></div>
    </div>
